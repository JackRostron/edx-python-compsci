...
def year_end_balance(s, i, m):
    '''
    s: Starting balance at the beginning on the year
    i: Annual interest rate
    m: Monthly repayment rate
    '''
    
    monthly_interest_rate = i / 12.0
    balance = s
    
    for x in range(0, 12): # Loop for each month
        minimum_monthly_payment = m * balance
...
year_end_balance(balance, annualInterestRate, monthlyPaymentRate)
